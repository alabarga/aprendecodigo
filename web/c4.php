			...
			<div role="main" class="main">
				...
				<section class="page-top">
					<div class="container">
						<div class="row">
							<div class="col-md-8">
								<ul class="breadcrumb">
									...
									<li class="active">(C) Animaciones</li>
								</ul>
							</div>
						...
						<div class="row">
							<div class="col-md-8">
                                <h1>C4 - <strong>Depúralo</strong></h1>
							</div>
...
<!-- ************************** BARRA LATERAL IZQUIERDA **************************** -->
                                ...
                                <div class="progress-bars">
								    <div class="progress progress-act">
									   <div class="progress-bar progress-bar-primary" data-appear-progress-animation="80%">
										<span class="progress-bar-tooltip">4/5</span>
									   </div>
								    </div>
                                    <div class="progress-label-act">
									   <span>Actividad 4 de 5</span>
								    </div>
                    ...
                    <!-- MARCAR ACTIVIDAD CORRESPONDIENTE -->
								...
								<ul class="nav nav-list primary push-bottom">
                                    <li><a href="c1.php">C1 - Monta una banda</a></li>
                                    <li><a href="c2.php">C2 - Cuadrado naranja, círculo morado</a></li>
                                    <li><a href="c3.php">C3 - ¡Está vivo!</a></li>
                                    <li><a href="c4.php"><strong>C4 - Depúralo</strong></a></li>
                                    <li><a href="c5.php">C5 - Vídeo musical</a></li>
								</ul>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
								            ...
								            <iframe frameborder="0" allowfullscreen="" src="https://www.youtube.com/embed/3qNDCmuJgpQ"></iframe>
							             </div>
										</div>
						...
						<div class="col-md-9">
                            ...
                            <div class="row">  
                                <div class="col-md-9">
                                    ...
                                    <p class="lead">En esta actividad investigarás qué está funcionando mal y encontrarás una solución para un desafío de depuración.</p>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="toggle" data-plugin-toggle data-plugin-options='{ "isAccordion": true }'>
								        <section class="toggle active">
									       ...
									       <div class="toggle-content">
                                               <div class="col-md-12 col-sm-12">
                                                   <p class="lead">Ve al proyecto <a href="http://scratch.mit.edu/projects/23266426/"  target="_blank">Debug It 2.1!</a></p>
                                               </div>
								        ...
								        <section class="toggle">
									       ...
									       <div class="toggle-content">
                                               <div class="col-md-12 col-sm-12">
                                                   <p class="lead"> En este proyecto el gato de Scratch quiere mostrarte un baile. Cuando haces click en él, debería hacer un baile mientras suena un tambor. Sin embargo, al comenzar a bailar el gato se para y el tambor sigue sin él. ¿Cómo arreglamos este programa?
</p>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <h2>Para<strong> explorar</strong></h2>
                                        ...
                                        <ul class="list icons list-unstyled">
                                            ...
                                            <li><i class="fa fa-flask"></i>¡Lleva el registro de tu trabajo! Esto puede ser muy práctico para recordar en el futuro lo que ya has probado y señalarte lo que probar a continuación.</li>
...
<!-- *******************     ¿HAS ACABADO?    ****************************************-->	          
 ...
 <!-- *******************     PAGINACION    ****************************************-->	       
                            <div class="row row-centered">
                                    ...
                                    <a href="c3.php" class="btn btn-primary btn-lg"><i class="fa fa-chevron-left"></i> Anterior</a>
                                    <a href="c5.php" class="btn btn-primary btn-lg">Siguiente<i class="fa fa-chevron-right"></i></a>
