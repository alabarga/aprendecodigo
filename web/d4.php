			...
			<div role="main" class="main">
				...
				<section class="page-top">
					<div class="container">
						<div class="row">
							<div class="col-md-8">
								<ul class="breadcrumb">
									...
									<li class="active">(D) Historias</li>
								</ul>
							</div>
						...
						<div class="row">
							<div class="col-md-8">
                                <h1>D4 - <strong>Depúralo</strong></h1>
							</div>
...
<!-- ************************** BARRA LATERAL IZQUIERDA **************************** -->
                                ...
                                <div class="progress-bars">
								    <div class="progress progress-act">
									   <div class="progress-bar progress-bar-primary" data-appear-progress-animation="100%">
										<span class="progress-bar-tooltip">4/4</span>
									   </div>
								    </div>
                                    <div class="progress-label-act">
									   <span>Actividad 4 de 4</span>
								    </div>
                    ...
                    <!-- MARCAR ACTIVIDAD CORRESPONDIENTE -->
								...
								<ul class="nav nav-list primary push-bottom">
									<li><a href="d1.php">D1 - Personajes</a></li>
                                    <li><a href="d2.php">D2 - Conversaciones</a></li>
                                    <li><a href="d3.php">D3 - Escenas</a></li>
                                    <li><a href="d4.php"><strong>D4 - Depúralo</strong></a></li>	
								</ul>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
								            ...
								            <iframe frameborder="0" allowfullscreen="" src="https://www.youtube.com/embed/A9tCyg-katU"></iframe>
							             </div>
										</div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="toggle" data-plugin-toggle data-plugin-options='{ "isAccordion": true }'>
								        <section class="toggle active">
									       ...
									       <div class="toggle-content">
                                               <div class="col-md-12 col-sm-12">
                                                   <p class="lead">Ve al proyecto <a href="http://scratch.mit.edu/projects/24269007"  target="_blank">Debug It 3.1!</a></p>
                                               </div>
								        ...
								        <section class="toggle">
									       ...
									       <div class="toggle-content">
                                               <div class="col-md-12 col-sm-12">
                                                   <p class="lead"> En este proyecto el gato Scratch enseña a Gobo cómo maullar. Pero cuando le toca a Gobo, Gobo se queda callado. ¿Cómo arreglamos el programa?</p>
...
<!-- *******************     ¿HAS ACABADO?    ****************************************-->	          
 ...
 <!-- *******************     PAGINACION    ****************************************-->	       
                            <div class="row row-centered">
                                    ...
                                    <a href="d3.php" class="btn btn-primary btn-lg"><i class="fa fa-chevron-left"></i> Anterior</a>
                                    <a href="e1.php" class="btn btn-primary btn-lg">Siguiente<i class="fa fa-chevron-right"></i></a>
